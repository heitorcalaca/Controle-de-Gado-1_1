...
public class Filhotes {
    ...
    public void setIdfilhote(Integer idfilhote) {
    ...
    public String getSituacaomae() {
        return situacaomae;
    }

    public void setSituacaomae(String situacaomae) {
        this.situacaomae = situacaomae;
    }
